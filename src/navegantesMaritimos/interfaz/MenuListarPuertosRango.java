...
/**
 * Este menu permite realizar la opcion de listar puertos en un rango.
 */
public class MenuListarPuertosRango extends javax.swing.JFrame {

    private final NavegantesMaritimos nav;
    private final JFrame framePadre;

    public MenuListarPuertosRango(NavegantesMaritimos nav, JFrame framePadre) {
        this.nav = nav;
    ...
    private void initComponents() {
        ...
        panelListarPuertosRango = new javax.swing.JPanel();
        ...
        setTitle("Listar puertos en un rango");
        setUndecorated(true);
        setResizable(false);
        ...
        panelListarPuertosRango.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED)), "Listar puertos en un rango"));
        ...
        javax.swing.GroupLayout panelListarPuertosRangoLayout = new javax.swing.GroupLayout(panelListarPuertosRango);
        panelListarPuertosRango.setLayout(panelListarPuertosRangoLayout);
        panelListarPuertosRangoLayout.setHorizontalGroup(
            panelListarPuertosRangoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelListarPuertosRangoLayout.createSequentialGroup()
                .addGap(49, 49, 49)
                .addGroup(panelListarPuertosRangoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panelListarPuertosRangoLayout.setVerticalGroup(
            panelListarPuertosRangoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelListarPuertosRangoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelListarPuertosRangoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelPuertoDestino)
                    .addComponent(labelPuertoOrigen))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelListarPuertosRangoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelListarPuertosRango, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void buttonListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonListarActionPerformed
        if (Validador.noVacio(labelSelecPuertoOrigen)
            ...
            Lista res = nav.listarPuertosRango(puertoOrigen, puertoDestino);
            if (!res.esVacia()) {
                JOptionPane.showMessageDialog(this,
                        "Los puertos que estan alfabeticamente "
                        + "entre el puerto " + puertoOrigen
                        + " y el puerto " + puertoDestino
                        + " son: \n" + res.toString() + ".", "Resultado", 1);
            } else {
                JOptionPane.showMessageDialog(this, "Ha ocurrido un error. Intentelo nuevamente", "Error", 0);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuListarPuertosRango.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuListarPuertosRango(null, null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel panelListarPuertosRango;
